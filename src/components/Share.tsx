...
const START_DATE = DateTime.fromISO("2022-02-19");
...
export function Share({
  ...
  const shareText = useMemo(() => {
    ...
    const title = `#WorldleinJapanese #${dayCount} ${guessCount}/6 ${bestPercent}${difficultyModifierEmoji}`;
    ...
    return [
      title,
      guessString,
      "https://kzmw.github.io/worldle-in-japanese/",
    ].join("\n");
